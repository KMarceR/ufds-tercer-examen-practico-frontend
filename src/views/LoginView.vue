      ...
      <v-col xs="12" sm="4" md="4" lg="4" xl="4" xxl="4">
        <v-card>
          <v-img
            height="150"
            cover
            src="https://www.salesforce.com/content/dam/web/es_mx/blog/seguimiento-deventas-como-hacer.jpg"
          >
          </v-img>
          <v-card-text>
            ...
            <v-form>
              ...
              ></v-text-field>
              <v-btn color="indigo" block @click="login">Iniciar sesión</v-btn>
            </v-form>
          </v-card-text>
        </v-card>
      </v-col>
...
export default {
  ...
  methods: {
    ...
    login() {
      axios
        .post("http://127.0.0.1:8000/api/usuario/login", this.usuario)
        .then((response) => {
